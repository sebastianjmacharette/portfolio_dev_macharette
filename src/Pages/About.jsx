...
function About() {
 ...
 <div className="inline-flex lg:mt-0 sm:mt-4 items-center justify-center w-full">
    ...
    <span className="absolute px-3 font-medium text-purple-700 text-xl -translate-x-1/2 bg-white left-1/2 ">Sobre mi</span>
</div>
      ...
      <div className="flex flex-col items-center justify-center lg:w-1/2 w-full p-4 pt-1 pb-0 lg:-mt-8">
        ...
        <p className="text-2xl text-center lg:leading-relaxed sm:leading-normal text-zinc-600">
          <span className="font-bold italic text-purple-600" >Mi misión </span>es llevar tus visiones al siguiente nivel, utilizando las
